...
public class car3 : MonoBehaviour {
	...
	void Start () {
		...
		v[0] = new Vector3 (64, -1, 13);
		v[1] = new Vector3 (91, -1, 13);
		v[2] = new Vector3 (116, -1, 13);
		v[3] = new Vector3 (116, -1, 39);
		v[4] = new Vector3 (116, -1, 64);
		v[5] = new Vector3 (91, -1, 64);
		v[6] = new Vector3 (64, -1, 64);
		v[7] = new Vector3 (64,-1,38);
