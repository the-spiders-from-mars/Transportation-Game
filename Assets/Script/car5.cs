...
public class car5 : MonoBehaviour {
	...
	void Start () {
		...
		v[0] = new Vector3 (3, -1, 101);
		v[1] = new Vector3 (3, -1, 73);
		v[2] = new Vector3 (33, -1, 73);
		v[3] = new Vector3 (56, -1, 73);
		v[4] = new Vector3 (56, -1, 101);
		v[5] = new Vector3 (56, -1, 126);
		v[6] = new Vector3 (33, -1, 126);
		v[7] = new Vector3 (3,-1,126);
