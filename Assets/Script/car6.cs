...
public class car6 : MonoBehaviour {
	...
	void Start () {
		...
		v[0] = new Vector3 (58, -1, 103);
		v[1] = new Vector3 (58, -1, 134);
		v[2] = new Vector3 (90, -1, 134);
		v[3] = new Vector3 (123, -1, 134);
		v[4] = new Vector3 (123, -1, 103);
		v[5] = new Vector3 (123, -1, 66);
		v[6] = new Vector3 (90, -1, 66);
		v[7] = new Vector3 (58,-1,66);
