...
public class car7 : MonoBehaviour {
	...
	void Start () {
		...
		v[0] = new Vector3 (60, -1, 133);
		v[1] = new Vector3 (116, -1, 133);
		v[2] = new Vector3 (116, -1, 150);
		v[3] = new Vector3 (116, -1, 166);
		v[4] = new Vector3 (66, -1, 166);
		v[5] = new Vector3 (3, -1, 166);
		v[6] = new Vector3 (3, -1, 150);
		v[7] = new Vector3 (3,-1,133);
