...
public class car2 : MonoBehaviour {
	...
	void Start () {
		...
		v[0] = new Vector3 (-3, -1, 74);
		v[1] = new Vector3 (62, -1, 74);
		v[2] = new Vector3 (124, -1, 74);
		v[3] = new Vector3 (124, -1, 42);
		v[4] = new Vector3 (124, -1, 9);
		v[5] = new Vector3 (62, -1, 9);
		v[6] = new Vector3 (-3, -1, 9);
		v[7] = new Vector3 (-3,-1,42);
