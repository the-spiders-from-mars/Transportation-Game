...
public class car8 : MonoBehaviour {
	...
	void Start () {
		...
		v[0] = new Vector3 (6, -1, 133);
		v[1] = new Vector3 (62, -1, 133);
		v[2] = new Vector3 (62, -1, 70);
		v[3] = new Vector3 (62, -1, 6);
		v[4] = new Vector3 (30, -1, 6);
		v[5] = new Vector3 (-1, -1, 6);
		v[6] = new Vector3 (-1, -1, 6);
		v[7] = new Vector3 (-1,-1,133);
